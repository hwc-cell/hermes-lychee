export default {
  ...
  deepseekDesc: "DeepSeek coding & chat models",
  deepseekTag: "",
  qwenName: "Qwen (Alibaba)",
  qwenDesc: "Tongyi Qianwen models",
  qwenTag: "",
  glmName: "Zhipu GLM",
  glmDesc: "Zhipu AI GLM models",
  glmTag: "",
  kimiName: "Kimi / Moonshot",
  kimiDesc: "Moonshot AI models",
  kimiTag: "",
  minimaxName: "MiniMax",
  minimaxDesc: "MiniMax models (global)",
  minimaxTag: "",
  localTag: "",
  ...
  braveHint: "Brave Search web search",
  serperApiKey: "Serper API Key",
  serperHint: "Google Search via Serper.dev",
  bingApiKey: "Bing Search API Key",
  bingHint: "Bing web search (Azure)",
